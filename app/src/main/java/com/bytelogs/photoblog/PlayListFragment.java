...
public class PlayListFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState){
       ...
       context = getActivity().getApplicationContext();
        ...
        playlist_id = "PLnyQlAp8jK6CNJFLQMY8OHdIQkyQExXA3";
        int videoTxtColor = Color.parseColor("#000000");
        loadTitle = "Loading...";
        loadMsg = "Loading your videos...";
        browserKey = "AIzaSyDxqpurqZ--yG0M9EuZdVIuzeV5CaYlc5w";
        int cornerRadius = 5;
        ...
        mVideoAdapter = new PlayListAdapter(displaylistArray, browserKey, getActivity(), cornerRadius, cardColor, videoTxtColor);
